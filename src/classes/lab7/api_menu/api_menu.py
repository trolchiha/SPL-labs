...
class APIMenu:
    ...
    def player_menu(self):
        ...
        player_menu.add_item(Item("1", "Get Artist's Top Tracks", self.__get_artist_top_tracks))
        player_menu.add_item(Item("2", "Get Artist's Albums", self.__get_artist_albums))
        player_menu.add_item(Item("3", "Get Recommendations", self.__get_recommendations))
